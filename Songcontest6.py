...
for i in range(10):
    ...
    if player1_value > player2_value:
        print("player 1 wins-->You can listen System of a Down music")
        ...
        print("It's a draw-->Listen both Metallica and System of a Down music")
    ...
    if player2_value > player3_value:
        print("player 2 wins-->You can listen System of a Down music")
        player2_score = player3_score + 1  # This is how we increment a variable
    elif player2_value > player3_value:
        print("player 2 wins-->You can listen Metallica music")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->Listen both System of a Down and Metallica music")
    if player4_value > player3_value:
        print("player 4 wins-->You can listen System of a Down music")
